function [Lambda,LikeL] = sampleLambda(Data,EmpParam,S,Lambda_Old,Alpha,Beta,Alpha_Prop,Ntmp,T_IRF,T_intv,Sig_IRF)
...
for ii = 1:length(Data)
    Stmp = cat(1,Stmp,S(ii).S(Data(ii).W==1));
    Dt = cat(1,Dt,Data(ii).Dt);
end
